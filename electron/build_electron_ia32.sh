...
patch -p1  --ignore-whitespace < ../libchromiumcontent_ia32.diff
script/bootstrap
#61.0.3163.100
...
script/update -t ia32  --skip_gclient
script/build -c static_library -t ia32
script/build -c ffmpeg -t ia32
script/create-dist -c static_library -t ia32
...
patch  -p1 --ignore-whitespace < ../update.diff
python ./script/bootstrap.py -v --clang_dir=/usr --target_arch=ia32
