...
#Building LightTable ...
echo "Building LightTable ..."

git clone https://github.com/LightTable/LightTable.git
cd LightTable
mkdir deploy/platform/freebsd
cp deploy/platform/linux/light deploy/platform/freebsd/
mkdir deploy/electron/electron
unzip ../electron/dist/electron-v0.36.5-freebsd-x64.zip -d deploy/electron/electron/
patch -p1 < ../lighttable.diff
script/build.sh
#./builds/lighttable-0.8.1-freebsd/LightTable
